...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_NLC_PERF_CONF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_NLC_PERF_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_PROXY_FILTER_SIZE, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SENSOR_SRV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SENSOR_SRV_SENSORS_MAX, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SENSOR_SRV_SETTINGS_MAX, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LOG_LEVEL_DBG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_PROVISIONEE_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MODEL_EXTENSION_LIST_SIZE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_COMP_PAGE_2, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_ACCESS_DELAYABLE_MSG_COUNT, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_ACCESS_DELAYABLE_MSG_CHUNK_SIZE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_ACCESS_DELAYABLE_MSG_CHUNK_COUNT, 60);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MODEL_KEY_COUNT, 3);
